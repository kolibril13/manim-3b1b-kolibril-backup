...
class DrawScene(ThreeDScene):
    ...
    def construct(self):
        ...
        def func(t):
            return np.array((np.cos( t), np.sin( t), 0.5+0.8*np.cos(t)))
        ...
        func.fade(1)
        self.add(dot)
        text = TexMobject(r" S_1(",r"t",r")= R \left( \begin{array}{c} \cos( \omega t) \\ \sin( \omega t)\\ 0 \end{array} \right)+ \left( \begin{array}{c} 0 \\ 0\\ \cos(\omega t) \end{array} \right) ")
