...
class No20d(Scene):
    def construct(self):
        ...
        kP_on = 11.6
        N=2000  #->2000 final
        concentration_fraction= 4*kP_off/kP_on
        ...
        blue_dot = Dot(radius= 0.3, color= BLUE).shift(2*LEFT)
        ...
        #eq
        ec1=TexMobject(r"c_A \text{ even higher}  \rightarrow \text{growing filament}")
        ec1.next_to(sq, DOWN)
